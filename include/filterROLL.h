...
int		P1_roll = 4; // watch out! if P1_roll is higher then C2_R_BIAS_UPDATE then things will go wrong
int		P2_roll = 6; // watch out! if P2_roll is higher then C2_R_BIAS_UPDATE then things will go wrong
