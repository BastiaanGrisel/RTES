...
int		P2_roll = 10; // watch out! if P2_roll is higher then C2_R_BIAS_UPDATE then things will go wrong
...
int rollControl(int rollRate,int roll_angle, int R_js){
	...
	//     calculate stabilization
	    R_stabilize = R_js + DECREASE_SHIFT(0-R_angle,C2_R_BIAS_UPDATE - P1_roll)
